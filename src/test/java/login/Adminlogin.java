...
public class Adminlogin {
	...
	public void loginstarelabs() throws InterruptedException {
		...
		driver.findElement(By.id("user_name")).sendKeys("20AD001");
	...
	public void signoutstarelabs() throws InterruptedException {
		 Thread.sleep(5000);
		 driver.findElement(By.xpath("/html/body/app-root/app-features/div/div[1]/app-header/div/div[1]/div[2]/div[3]/img")).click();
